          ...
          <div class="container-xl">
            ...
            <div class="row g-4 settings-section">
              <div class="col-12 col-md-4">
                ...
                <div class="section-intro">
                  Find out what's in store for the future on our plan page, with
                  details on our strategies and upcoming steps.
                  <a href="help.html">Learn more</a>
                </div>
              </div>
              <div class="col-12 col-md-8">
            ...
            <div class="row g-4 settings-section">
              <div class="col-12 col-md-4">
                ...
                <div class="section-intro">
                  Learn about how we keep your information safe on our privacy
                  page. We're straightforward about our policies to ensure your
                  online experience is secure.
                </div>
              </div>
              <div class="col-12 col-md-8">
                <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <div class="row g-4 settings-section">
              <div class="col-12 col-md-4">
                ...
                <div class="section-intro">
                  Stay informed and connected with real-time updates on our
                  notification page, where important announcements and
                  personalized messages await you.
                </div>
              </div>
              <div class="col-12 col-md-8">
                <div class="app-card app-card-settings shadow-sm p-4">
                    ...
                    <form class="settings-form">
                      ...
                      <div class="form-check form-switch mb-3">
                        ...
                        <label class="form-check-label" for="settings-switch-2"
                          >Web browser push notifications</label
                        >
                      </div>
                      <div class="form-check form-switch mb-3">
                        <input
